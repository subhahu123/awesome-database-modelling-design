...
slug: /blogs/shipment-tracking-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `shipment-tracking-database-modelling/README.md`.

# Shipment Tracking Database Modelling

## 1) Problem statement

Design a production-grade schema for **Shipment Tracking** with:
