...
slug: /blogs/google-calendar-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `google-calendar-database-modelling/README.md`.

# Google Calendar Database Modelling

## 1) Problem statement

Design a production-grade schema for **Google Calendar** with:
