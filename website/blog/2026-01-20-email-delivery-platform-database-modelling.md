...
slug: /blogs/email-delivery-platform-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `email-delivery-platform-database-modelling/README.md`.

# Email Delivery Platform Database Modelling

## 1) Problem statement

Design a production-grade schema for **Email Delivery Platform** with:
