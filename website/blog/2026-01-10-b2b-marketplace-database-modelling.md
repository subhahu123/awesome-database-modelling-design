...
slug: /blogs/b2b-marketplace-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `b2b-marketplace-database-modelling/README.md`.

# B2B Marketplace Database Modelling

## 1) Problem statement

Design a production-grade schema for **B2B Marketplace** with:
