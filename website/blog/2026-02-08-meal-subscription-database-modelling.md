...
slug: /blogs/meal-subscription-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `meal-subscription-database-modelling/README.md`.

# Meal Subscription Database Modelling

## 1) Problem statement

Design a production-grade schema for **Meal Subscription** with:
