...
slug: /blogs/wallet-ledger-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `wallet-ledger-database-modelling/README.md`.

# Wallet / Ledger-first FinTech Database Modelling

## 1) Problem statement

Design a production-grade schema for **Wallet / Ledger-first FinTech** with:
