...
slug: /blogs/loan-origination-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `loan-origination-database-modelling/README.md`.

# Loan Origination Database Modelling

## 1) Problem statement

Design a production-grade schema for **Loan Origination** with:
