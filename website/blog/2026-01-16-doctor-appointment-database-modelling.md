...
slug: /blogs/doctor-appointment-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `doctor-appointment-database-modelling/README.md`.

# Doctor Appointment Database Modelling

## 1) Problem statement

Design a production-grade schema for **Doctor Appointment** with:
