...
slug: /blogs/ride-sharing-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `ride-sharing-database-modelling/README.md`.

# Ride Sharing (Uber/Ola style) Database Modelling

## 1) Problem statement

Design a production-grade schema for **Ride Sharing (Uber/Ola style)** with:
