...
slug: /blogs/e-learning-live-classes-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `e-learning-live-classes-database-modelling/README.md`.

# E-learning Live Classes Database Modelling

## 1) Problem statement

Design a production-grade schema for **E-learning Live Classes** with:
