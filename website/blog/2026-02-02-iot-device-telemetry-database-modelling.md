...
slug: /blogs/iot-device-telemetry-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `iot-device-telemetry-database-modelling/README.md`.

# IoT Device Telemetry Database Modelling

## 1) Problem statement

Design a production-grade schema for **IoT Device Telemetry** with:
