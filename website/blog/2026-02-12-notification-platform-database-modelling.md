...
slug: /blogs/notification-platform-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `notification-platform-database-modelling/README.md`.

# Notification Platform Database Modelling

## 1) Problem statement

Design a production-grade schema for **Notification Platform** with:
