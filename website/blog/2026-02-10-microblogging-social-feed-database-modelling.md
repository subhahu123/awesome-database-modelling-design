...
slug: /blogs/microblogging-social-feed-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `microblogging-social-feed-database-modelling/README.md`.

# Microblogging Social Feed Database Modelling

## 1) Problem statement

Design a production-grade schema for **Microblogging Social Feed** with:
