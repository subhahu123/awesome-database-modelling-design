...
slug: /blogs/video-conferencing-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `video-conferencing-database-modelling/README.md`.

# Video Conferencing Database Modelling

## 1) Problem statement

Design a production-grade schema for **Video Conferencing** with:
