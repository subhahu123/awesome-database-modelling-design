...
slug: /blogs/travel-itinerary-booking-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `travel-itinerary-booking-database-modelling/README.md`.

# Travel Itinerary Booking Database Modelling

## 1) Problem statement

Design a production-grade schema for **Travel Itinerary Booking** with:
