...
slug: /blogs/digital-library-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `digital-library-database-modelling/README.md`.

# Digital Library Database Modelling

## 1) Problem statement

Design a production-grade schema for **Digital Library** with:
