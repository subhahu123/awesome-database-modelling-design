...
slug: /blogs/project-management-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `project-management-database-modelling/README.md`.

# Project Management Database Modelling

## 1) Problem statement

Design a production-grade schema for **Project Management** with:
