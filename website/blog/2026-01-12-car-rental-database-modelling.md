...
slug: /blogs/car-rental-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `car-rental-database-modelling/README.md`.

# Car Rental Database Modelling

## 1) Problem statement

Design a production-grade schema for **Car Rental** with:
