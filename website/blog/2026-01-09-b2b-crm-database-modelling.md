...
slug: /blogs/b2b-crm-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `b2b-crm-database-modelling/README.md`.

# B2B CRM Database Modelling

## 1) Problem statement

Design a production-grade schema for **B2B CRM** with:
