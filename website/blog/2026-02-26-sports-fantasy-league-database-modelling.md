...
slug: /blogs/sports-fantasy-league-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `sports-fantasy-league-database-modelling/README.md`.

# Sports Fantasy League Database Modelling

## 1) Problem statement

Design a production-grade schema for **Sports Fantasy League** with:
