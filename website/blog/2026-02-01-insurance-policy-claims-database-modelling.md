...
slug: /blogs/insurance-policy-claims-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `insurance-policy-claims-database-modelling/README.md`.

# Insurance Policy & Claims Database Modelling

## 1) Problem statement

Design a production-grade schema for **Insurance Policy & Claims** with:
