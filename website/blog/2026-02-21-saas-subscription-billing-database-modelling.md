...
slug: /blogs/saas-subscription-billing-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `saas-subscription-billing-database-modelling/README.md`.

# SaaS Subscription Billing Database Modelling

## 1) Problem statement

Design a production-grade schema for **SaaS Subscription Billing** with:
