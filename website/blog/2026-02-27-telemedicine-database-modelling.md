...
slug: /blogs/telemedicine-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `telemedicine-database-modelling/README.md`.

# Telemedicine Database Modelling

## 1) Problem statement

Design a production-grade schema for **Telemedicine** with:
