...
slug: /blogs/crypto-exchange-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `crypto-exchange-database-modelling/README.md`.

# Crypto Exchange Database Modelling

## 1) Problem statement

Design a production-grade schema for **Crypto Exchange** with:
