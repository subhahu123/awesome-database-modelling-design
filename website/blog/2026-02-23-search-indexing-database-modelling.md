...
slug: /blogs/search-indexing-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `search-indexing-database-modelling/README.md`.

# Search Indexing Database Modelling

## 1) Problem statement

Design a production-grade schema for **Search Indexing** with:
