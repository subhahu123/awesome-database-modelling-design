...
slug: /blogs/gaming-leaderboard-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `gaming-leaderboard-database-modelling/README.md`.

# Gaming Leaderboard Database Modelling

## 1) Problem statement

Design a production-grade schema for **Gaming Leaderboard** with:
