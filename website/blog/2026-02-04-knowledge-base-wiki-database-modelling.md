...
slug: /blogs/knowledge-base-wiki-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `knowledge-base-wiki-database-modelling/README.md`.

# Knowledge Base / Wiki Database Modelling

## 1) Problem statement

Design a production-grade schema for **Knowledge Base / Wiki** with:
