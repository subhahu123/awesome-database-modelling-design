...
slug: /blogs/event-ticketing-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `event-ticketing-database-modelling/README.md`.

# Event Ticketing Database Modelling

## 1) Problem statement

Design a production-grade schema for **Event Ticketing** with:
