...
slug: /blogs/voting-polling-system-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `voting-polling-system-database-modelling/README.md`.

# Voting & Polling System Database Modelling

## 1) Problem statement

Design a production-grade schema for **Voting & Polling System** with:
