...
slug: /blogs/airline-reservation-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `airline-reservation-database-modelling/README.md`.

# Airline Reservation Database Modelling

## 1) Problem statement

Design a production-grade schema for **Airline Reservation** with:
