...
slug: /blogs/hotel-management-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `hotel-management-database-modelling/README.md`.

# Hotel Management Database Modelling

## 1) Problem statement

Design a production-grade schema for **Hotel Management** with:
