...
slug: /blogs/short-video-platform-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `short-video-platform-database-modelling/README.md`.

# Short Video Platform Database Modelling

## 1) Problem statement

Design a production-grade schema for **Short Video Platform** with:
