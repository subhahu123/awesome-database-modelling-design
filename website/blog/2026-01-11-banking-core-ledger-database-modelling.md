...
slug: /blogs/banking-core-ledger-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `banking-core-ledger-database-modelling/README.md`.

# Banking Core Ledger Database Modelling

## 1) Problem statement

Design a production-grade schema for **Banking Core Ledger** with:
