...
slug: /blogs/hr-payroll-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `hr-payroll-database-modelling/README.md`.

# HR & Payroll Database Modelling

## 1) Problem statement

Design a production-grade schema for **HR & Payroll** with:
