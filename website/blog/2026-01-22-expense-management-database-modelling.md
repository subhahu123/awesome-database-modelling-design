...
slug: /blogs/expense-management-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `expense-management-database-modelling/README.md`.

# Expense Management Database Modelling

## 1) Problem statement

Design a production-grade schema for **Expense Management** with:
