...
slug: /blogs/observability-metrics-logs-database-modelling
tags: [case-study, database-modelling]
---

> Imported from repository path: `observability-metrics-logs-database-modelling/README.md`.

# Observability Metrics & Logs Database Modelling

## 1) Problem statement

Design a production-grade schema for **Observability Metrics & Logs** with:
