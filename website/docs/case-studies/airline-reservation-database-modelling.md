---
title: "Airline Reservation Database Modelling"
slug: /case-studies/airline-reservation-database-modelling
---

import CaseStudyPlayground from '@site/src/components/CaseStudyPlayground';

> Source: `airline-reservation-database-modelling/README.md`
...
Open `/path/interactive-playground?case=airline-reservation-database-modelling` to experiment with indexes, retries, idempotency, and audit settings using a domain-tuned preset.
:::
...
<CaseStudyPlayground caseSlug="airline-reservation-database-modelling" />
