---
title: "Expense Management Database Modelling"
slug: /case-studies/expense-management-database-modelling
---

import CaseStudyPlayground from '@site/src/components/CaseStudyPlayground';

> Source: `expense-management-database-modelling/README.md`

# Expense Management Database Modelling
...
:::info Expense Management Database Modelling insight 1
Domain-specific correctness usually depends on clear state transitions, not only table completeness.
:::

:::info Expense Management Database Modelling insight 2
...
Open `/path/interactive-playground?case=expense-management-database-modelling` to experiment with indexes, retries, idempotency, and audit settings using a domain-tuned preset.
:::
...
<CaseStudyPlayground caseSlug="expense-management-database-modelling" />
