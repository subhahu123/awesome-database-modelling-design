---
title: "API Rate Limiting Database Modelling"
slug: /case-studies/api-rate-limiting-database-modelling
---

import CaseStudyPlayground from '@site/src/components/CaseStudyPlayground';

> Source: `api-rate-limiting-database-modelling/README.md`
...
Open `/path/interactive-playground?case=api-rate-limiting-database-modelling` to experiment with indexes, retries, idempotency, and audit settings using a domain-tuned preset.
:::
...
<CaseStudyPlayground caseSlug="api-rate-limiting-database-modelling" />
