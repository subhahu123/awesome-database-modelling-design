---
title: "Ad Tech Real-Time Bidding Database Modelling"
slug: /case-studies/ad-tech-bidding-database-modelling
---

import CaseStudyPlayground from '@site/src/components/CaseStudyPlayground';

> Source: `ad-tech-bidding-database-modelling/README.md`
...
Open `/path/interactive-playground?case=ad-tech-bidding-database-modelling` to experiment with indexes, retries, idempotency, and audit settings using a domain-tuned preset.
:::
...
<CaseStudyPlayground caseSlug="ad-tech-bidding-database-modelling" />
