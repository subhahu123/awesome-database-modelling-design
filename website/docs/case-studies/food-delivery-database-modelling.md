---
title: "Food Delivery (Swiggy/Zomato/UberEats style) Database Modelling"
slug: /case-studies/food-delivery-database-modelling
---

import CaseStudyPlayground from '@site/src/components/CaseStudyPlayground';

> Source: `food-delivery-database-modelling/README.md`
...
:::info Food Delivery Database Modelling insight 1
...
:::info Food Delivery Database Modelling insight 2
...
Open `/path/interactive-playground?case=food-delivery-database-modelling` to experiment with indexes, retries, idempotency, and audit settings using a domain-tuned preset.
:::
...
<CaseStudyPlayground caseSlug="food-delivery-database-modelling" />
