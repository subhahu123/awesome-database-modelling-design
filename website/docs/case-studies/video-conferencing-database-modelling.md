---
title: "Video Conferencing Database Modelling"
slug: /case-studies/video-conferencing-database-modelling
---

import CaseStudyPlayground from '@site/src/components/CaseStudyPlayground';

> Source: `video-conferencing-database-modelling/README.md`

# Video Conferencing Database Modelling
...
Open `/path/interactive-playground?case=video-conferencing-database-modelling` to experiment with indexes, retries, idempotency, and audit settings using a domain-tuned preset.
:::
