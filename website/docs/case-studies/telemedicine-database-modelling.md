---
title: "Telemedicine Database Modelling"
slug: /case-studies/telemedicine-database-modelling
---

import CaseStudyPlayground from '@site/src/components/CaseStudyPlayground';

> Source: `telemedicine-database-modelling/README.md`

# Telemedicine Database Modelling
...
Open `/path/interactive-playground?case=telemedicine-database-modelling` to experiment with indexes, retries, idempotency, and audit settings using a domain-tuned preset.
:::
...
<CaseStudyPlayground caseSlug="telemedicine-database-modelling" />
