---
title: "Short Video Platform Database Modelling"
slug: /case-studies/short-video-platform-database-modelling
---

import CaseStudyPlayground from '@site/src/components/CaseStudyPlayground';

> Source: `short-video-platform-database-modelling/README.md`
...
Open `/path/interactive-playground?case=short-video-platform-database-modelling` to experiment with indexes, retries, idempotency, and audit settings using a domain-tuned preset.
:::
...
<CaseStudyPlayground caseSlug="short-video-platform-database-modelling" />
