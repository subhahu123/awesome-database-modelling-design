---
title: "Fraud Risk Engine Database Modelling"
slug: /case-studies/fraud-risk-engine-database-modelling
---

import CaseStudyPlayground from '@site/src/components/CaseStudyPlayground';

> Source: `fraud-risk-engine-database-modelling/README.md`
...
Open `/path/interactive-playground?case=fraud-risk-engine-database-modelling` to experiment with indexes, retries, idempotency, and audit settings using a domain-tuned preset.
:::
...
<CaseStudyPlayground caseSlug="fraud-risk-engine-database-modelling" />
