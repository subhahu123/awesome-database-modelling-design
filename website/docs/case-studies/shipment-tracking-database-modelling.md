---
title: "Shipment Tracking Database Modelling"
slug: /case-studies/shipment-tracking-database-modelling
---

import CaseStudyPlayground from '@site/src/components/CaseStudyPlayground';

> Source: `shipment-tracking-database-modelling/README.md`

# Shipment Tracking Database Modelling
...
:::info Shipment Tracking Database Modelling insight 1
Domain-specific correctness usually depends on clear state transitions, not only table completeness.
:::

:::info Shipment Tracking Database Modelling insight 2
...
Open `/path/interactive-playground?case=shipment-tracking-database-modelling` to experiment with indexes, retries, idempotency, and audit settings using a domain-tuned preset.
:::
...
<CaseStudyPlayground caseSlug="shipment-tracking-database-modelling" />
