---
title: "B2B CRM Database Modelling"
slug: /case-studies/b2b-crm-database-modelling
---

import CaseStudyPlayground from '@site/src/components/CaseStudyPlayground';

> Source: `b2b-crm-database-modelling/README.md`

# B2B CRM Database Modelling
...
Open `/path/interactive-playground?case=b2b-crm-database-modelling` to experiment with indexes, retries, idempotency, and audit settings using a domain-tuned preset.
:::
...
<CaseStudyPlayground caseSlug="b2b-crm-database-modelling" />
