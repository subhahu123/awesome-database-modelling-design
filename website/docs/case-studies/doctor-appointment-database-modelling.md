---
title: "Doctor Appointment Database Modelling"
slug: /case-studies/doctor-appointment-database-modelling
---

import CaseStudyPlayground from '@site/src/components/CaseStudyPlayground';

> Source: `doctor-appointment-database-modelling/README.md`

# Doctor Appointment Database Modelling
...
:::info Doctor Appointment Database Modelling insight 1
Domain-specific correctness usually depends on clear state transitions, not only table completeness.
:::

:::info Doctor Appointment Database Modelling insight 2
...
Open `/path/interactive-playground?case=doctor-appointment-database-modelling` to experiment with indexes, retries, idempotency, and audit settings using a domain-tuned preset.
:::
...
<CaseStudyPlayground caseSlug="doctor-appointment-database-modelling" />
