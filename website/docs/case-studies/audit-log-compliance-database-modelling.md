---
title: "Audit Log & Compliance Database Modelling"
slug: /case-studies/audit-log-compliance-database-modelling
---

import CaseStudyPlayground from '@site/src/components/CaseStudyPlayground';

> Source: `audit-log-compliance-database-modelling/README.md`
...
:::info Audit Log Compliance Database Modelling insight 1
Domain-specific correctness usually depends on clear state transitions, not only table completeness.
:::

:::info Audit Log Compliance Database Modelling insight 2
...
Open `/path/interactive-playground?case=audit-log-compliance-database-modelling` to experiment with indexes, retries, idempotency, and audit settings using a domain-tuned preset.
:::
...
<CaseStudyPlayground caseSlug="audit-log-compliance-database-modelling" />
