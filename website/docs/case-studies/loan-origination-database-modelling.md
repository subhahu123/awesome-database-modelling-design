---
title: "Loan Origination Database Modelling"
slug: /case-studies/loan-origination-database-modelling
---

import CaseStudyPlayground from '@site/src/components/CaseStudyPlayground';

> Source: `loan-origination-database-modelling/README.md`

# Loan Origination Database Modelling
...
Open `/path/interactive-playground?case=loan-origination-database-modelling` to experiment with indexes, retries, idempotency, and audit settings using a domain-tuned preset.
:::
...
<CaseStudyPlayground caseSlug="loan-origination-database-modelling" />
