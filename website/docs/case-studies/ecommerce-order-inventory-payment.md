...
Open `/path/interactive-playground?case=ecommerce-order-inventory-payment` to experiment with indexes, retries, idempotency, and audit settings using a domain-tuned preset.
:::
