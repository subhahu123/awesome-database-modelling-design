---
title: "Hotel Management Database Modelling"
slug: /case-studies/hotel-management-database-modelling
---

import CaseStudyPlayground from '@site/src/components/CaseStudyPlayground';

> Source: `hotel-management-database-modelling/README.md`

# Hotel Management Database Modelling
...
Open `/path/interactive-playground?case=hotel-management-database-modelling` to experiment with indexes, retries, idempotency, and audit settings using a domain-tuned preset.
:::
...
<CaseStudyPlayground caseSlug="hotel-management-database-modelling" />
