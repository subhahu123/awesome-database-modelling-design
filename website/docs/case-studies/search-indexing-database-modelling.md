---
title: "Search Indexing Database Modelling"
slug: /case-studies/search-indexing-database-modelling
---

import CaseStudyPlayground from '@site/src/components/CaseStudyPlayground';

> Source: `search-indexing-database-modelling/README.md`

# Search Indexing Database Modelling
...
Open `/path/interactive-playground?case=search-indexing-database-modelling` to experiment with indexes, retries, idempotency, and audit settings using a domain-tuned preset.
:::
...
<CaseStudyPlayground caseSlug="search-indexing-database-modelling" />
