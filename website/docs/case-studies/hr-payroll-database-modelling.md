---
title: "HR & Payroll Database Modelling"
slug: /case-studies/hr-payroll-database-modelling
---

import CaseStudyPlayground from '@site/src/components/CaseStudyPlayground';

> Source: `hr-payroll-database-modelling/README.md`

# HR & Payroll Database Modelling
...
Open `/path/interactive-playground?case=hr-payroll-database-modelling` to experiment with indexes, retries, idempotency, and audit settings using a domain-tuned preset.
:::
...
<CaseStudyPlayground caseSlug="hr-payroll-database-modelling" />
