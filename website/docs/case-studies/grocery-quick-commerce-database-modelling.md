---
title: "Grocery Quick Commerce Database Modelling"
slug: /case-studies/grocery-quick-commerce-database-modelling
---

import CaseStudyPlayground from '@site/src/components/CaseStudyPlayground';

> Source: `grocery-quick-commerce-database-modelling/README.md`
...
:::info Grocery Quick Commerce Database Modelling insight 1
...
:::info Grocery Quick Commerce Database Modelling insight 2
...
Open `/path/interactive-playground?case=grocery-quick-commerce-database-modelling` to experiment with indexes, retries, idempotency, and audit settings using a domain-tuned preset.
:::
...
<CaseStudyPlayground caseSlug="grocery-quick-commerce-database-modelling" />
